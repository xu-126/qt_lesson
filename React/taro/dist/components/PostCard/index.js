...
var PostCard = (_temp2 = _class = function (_Taro$Component) {
  ...
  function PostCard() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = PostCard.__proto__ || Object.getPrototypeOf(PostCard)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["props"], _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
