...
var listWrapper = document.querySelector('.list-wrapper-hook'),  //Z整个内容
    listContent = document.querySelector('.list-content-hook'),  // 列表
    alert = document.querySelector('.alert-hook'), // 刷新成功
    topTip = document.querySelector('.refresh-hook'),  // 下拉刷新
    bottomTip = document.querySelector('.loading-hook'); //加载
/*
...
function reloadData() {
  ...
  var template = '<li class="list-item"><div class="text">1</div></li>'
  // 向ul容器中添加内容
