<template>
  <div class="container ub-box ub-col">
      ...
      <scroll-view scroll-y style="height: cala(100vh - 50px);" scroll-top="0">
          <swiper class="swiper" indicator-dots="false" autoplay="false" interval="5000" duration="500">
              <bolck v-for="(item,index) in imgUrls" :key="index">
                  <swiper-item>
                      <image class="z-width-1000percent" mode="widthFix" :src="item"></image>
                  </swiper-item>
              </bolck>
          </swiper>
